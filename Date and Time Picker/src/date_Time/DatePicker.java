	 ...
	 @Test
	    ...
	    public void testDAtePicker() throws Exception{
		 //DAte and Time to be set in textbox
	        ...
	        String dateTime ="28/02/2017 2:00 PM";
	      ...
	      //button to open calendar
	        ...
	        WebElement selectDate = driver.findElement(By.xpath(".//*[@id='example']/div/span/span/span/span[1]/span"));
	        ...
	        midLink.click();
	            ...
	            List<WebElement> list_AllMonthToBook = driver.findElements(By.xpath("//div[@id='datetimepicker_dateview']"
